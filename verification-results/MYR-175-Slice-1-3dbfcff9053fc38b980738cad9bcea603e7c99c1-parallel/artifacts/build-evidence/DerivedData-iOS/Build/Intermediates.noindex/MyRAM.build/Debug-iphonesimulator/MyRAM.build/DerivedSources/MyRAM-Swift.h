...
#ifndef MYRAM_SWIFT_H
#define MYRAM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyRAM",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC5MyRAM19MyRAMSyncController")
@interface MyRAMSyncController : NSObject
...
@class NSData;
@class MCSession;
@interface MyRAMSyncController (SWIFT_EXTENSION(MyRAM)) <MCNearbyServiceAdvertiserDelegate>
...
@class NSString;
@interface MyRAMSyncController (SWIFT_EXTENSION(MyRAM)) <MCNearbyServiceBrowserDelegate>
...
@class NSProgress;
@class NSURL;
@interface MyRAMSyncController (SWIFT_EXTENSION(MyRAM)) <MCSessionDelegate>
